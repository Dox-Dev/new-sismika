...
<h1 class="h1">Seismic Station Entry Submission</h1>
<hr />
...
>
	<article class="card flex-row m-4 p-1 space-y-3">
		<div class="input-group input-group-divider grid-cols-[auto_1fr_auto]">
			<div class="input-group-shim">Code</div>
			<input type="text" name="code" title="Code" value={form?.code ?? ''} />
		</div>
		<div class="input-group input-group-divider grid-cols-[auto_1fr_auto]">
		...
		<div class="input-group input-group-divider grid-cols-[auto_1fr_auto]">
			...
			<input type="text" name="type" title="Type" value={form?.type ?? ''} />
		</div>
		<div class="input-group input-group-divider grid-cols-[auto_1fr_auto]">
