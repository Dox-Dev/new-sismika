import { getAllEarthquakeData, getAllStationData, getLocationFromPSGC } from '$lib/server/database/index.js';
...
export async function load({params: {id}}) {
    ...
    return { equake: res.equakes, totalCount: res.totalCount, location, station: stations.stations, evac: []}
}